...
numbers.forEach(getIndexAndValue);
...
/**
 * Filter methods takes call back as an input and returns an array 
...
// Reduce method ---- takes and call back function and returns a new array 
...
// sortes them oon the basic of ascii value i.e on the basic of ascii value of chars 
...
// finc function -- takes call back as an argument and returns the first occurence ele
...
// some method -- checks if any ele  satifies the condition 
...
let deleteItem = item.splice(1,2); // startIdx = 1 , UpTOIdx 2 we have to delete everything 
